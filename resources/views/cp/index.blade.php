            ...
            <div class="sidebar custom-scrollbar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a class="sidebar-header" href="{{route('home')}}"><i data-feather="home"></i>
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="{{asset('admins')}}"><i class="fa fa-circle"></i><span>المشرفين</span></a></li>
                            {{--@if(auth()->user()->hasPermissionTo('View user'))--}}

                            <li><a href="{{asset('shopss')}}"><i class="fa fa-circle"></i><span>المتاجر</span></a></li>
                            <li><a href="{{asset('clients')}}"><i class="fa fa-circle"></i><span>المستخدمين</span></a>
                            </li>
                    ...
                    <li><a class="sidebar-header" href="{{asset('offs')}}"><i data-feather="home"></i>
                            <span>الاعلانات</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    {{--@if(admin()->hasPermissionTo('View rate'))--}}
                    <li><a class="sidebar-header" href="{{asset('reviews')}}"><i data-feather="home"></i>
                            <span>التقييمات</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    <li><a class="sidebar-header" href="{{asset('notifications')}}"><i data-feather="home"></i>
                            <span>الاشعارات</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    {{--@if(admin()->hasPermissionTo('View notification'))--}}
                    <li><a class="sidebar-header" href="{{asset('reports')}}"><i data-feather="home"></i>
                            <span>التقارير</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    <li><a class="sidebar-header" href="{{asset('terms')}}"><i data-feather="home"></i>
                            <span>الشلروط و الاحكام</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    {{--@endif--}}
                    ...
                    <li><a class="sidebar-header" href="{{asset('abouts')}}"><i data-feather="home"></i>
...
<script>
    $(document).ready(function () {
        ...
        /*offers charts*/
        @if(isset($offers_charts))
        if ($("#_offers").length > 0) {
            var data = google.visualization.arrayToDataTable([
                ["Element", " Offers", {role: "style"}],
                    @if(isset($offers_charts))
                    @foreach($offers_charts as $test)
                [" {{$test->date  }} ", {{ $test->count }} , "#1D2D44"],
                @endforeach
                @endif
            ]);
            ...
            var chart = new google.visualization.ColumnChart(document.getElementById("_offers"));
            chart.draw(view, options);
        }
        @endif
        ...
        /*offers charts*/
        @if(isset($rates_charts))
        if ($("#_rates").length > 0) {
            var data = google.visualization.arrayToDataTable([
                ["Element", "Rates", {role: "style"}],
                    @if(isset($rates_charts))
                    @foreach($rates_charts as $test)
                [" {{$test->date  }} ", {{ $test->count }} , "#1D2D44"],
                @endforeach
                @endif
            ]);
            ...
            var chart = new google.visualization.ColumnChart(document.getElementById("_rates"));
            chart.draw(view, options);
        }
        @endif
